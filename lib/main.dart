...
class MyApp extends StatelessWidget {
  ...
  const List <Opcao> opcoes = <Opcao>[
    ...
    Opcao(titulo:'Carro', icon: Icons.directions_bus),
    Opcao(titulo:'Carro', icon: Icons.directions_railway),
    Opcao(titulo:'Carro', icon: Icons.directions_walk),
    Opcao(titulo:'Carro', icon: Icons.directions_car),
    Opcao(titulo:'Carro', icon: Icons.drafts),
    Opcao(titulo:'Carro', icon: Icons.dvr),
    Opcao(titulo:'Carro', icon: Icons.copyright),
    Opcao(titulo:'Carro', icon: Icons.cloud_off),
    Opcao(titulo:'Carro', icon: Icons.directions_car),
    Opcao(titulo:'Carro', icon: Icons.directions_bike),
    Opcao(titulo:'Carro', icon: Icons.directions_boat),
    Opcao(titulo:'Carro', icon: Icons.directions_bus),
    Opcao(titulo:'Carro', icon: Icons.directions_railway),
    Opcao(titulo:'Carro', icon: Icons.directions_walk),
    Opcao(titulo:'Carro', icon: Icons.directions_car),
